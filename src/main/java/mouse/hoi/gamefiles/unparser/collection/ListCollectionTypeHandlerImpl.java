...
@Service
public class ListCollectionTypeHandlerImpl implements CollectionTypeHandler {

    private final UnparsingCollectionCommon unparsingCollectionCommon;
    @Autowired
    public ListCollectionTypeHandlerImpl(UnparsingCollectionCommon unparsingCollectionCommon) {
